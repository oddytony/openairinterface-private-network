...
static const ProtobufCFieldDescriptor protocol__flex_ue_stats_report__field_descriptors[13] =
{
  {
    "rnti",
    1,
...
static const ProtobufCEnumValue protocol__flex_ue_stats_type__enum_values_by_number[11] =
{
...
{1, 0},{4, 2},{8, 3},{16, 4},{32, 5},{64, 6},{128, 7},{1024, 8},{2048, 9},{65536, 10},{0, 11}
};
static const ProtobufCEnumValueIndex protocol__flex_ue_stats_type__enum_values_by_name[11] =
{
  { "FLUST_BSR", 0 },
  { "FLUST_DL_CQI", 4 },
  { "FLUST_GTP_STATS", 9 },
